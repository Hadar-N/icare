...
SPRITE_MAX_SPEED = 5
SPRITE_MIN_SPEED = 1
SPRITE_MAX_COVERED = .2
SPRITE_COVERED_FRAMES_BEFORE_DEL = int(CLOCK*3)
...
FIREWORK_SPEED = .3
FIREWORK_DISAPPEAR_SPEED = 8

# calibration consts
BOUNDARY_RADIUS = 10
CAMERA_SETUP_ATTEMPTS = 5