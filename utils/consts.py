...
FREE_AREA_FOR_FISH = 20; FISH_BORDER = 3; FISH_APPEAR_SPEED = 0.05; FISH_STUCK_THRESH = 6; FISH_MAX_SPEED = 3; FISH_MAX_OPACITY = 200
...
VOCAB_PATH = 'public/vocab.json'; VOCAB_AMOUNT = 10; MAX_VOCAB_ACTIVE = 3
